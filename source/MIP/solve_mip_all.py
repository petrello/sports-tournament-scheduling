#!/usr/bin/env python3
"""
Batch MIP Solver: Script to run multiple MIP instances automatically.
"""
import json
import os
import pathlib
...
instances_path = pathlib.Path(__file__).parent.parent.parent / 'instances' / 'MIP'
...
def main():
        ...
        for exp_idx, exp_name in enumerate(EXPERIMENTS_CONFIG.keys()):
            ...
            if prev_instance_data and len(prev_instance_data[exp_name]['sol']) == 0:
                ...
                cmd = [
                    ...
                    str(EXPERIMENTS_CONFIG[exp_name]['mip_solver']),
                    instance_file,
    ...
    print("\n\n" + "*" * 50)
    print(f"* {'All MIP experiments completed!'.center(46)} *")
    print("*" * 50)
    return 0
